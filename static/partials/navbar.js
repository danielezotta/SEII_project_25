            ...
            $("#navbar_status_right").html(`
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right text-right bg-dark " aria-labelledby="navbar_status_right_dropdown">
                        <a class="nav-link" href="myOrders.html">I miei ordini</a>
                        <a class="nav-link" href="myProducts.html">I miei prodotti</a>
                        <a class="nav-link" href="sellProducts.html">Metti in vendita</a>
