...
describe('api.test', () => {
    ...
    beforeAll( async () => {
        ...
        var createServer = new Promise( (resolve, reject) => {
    ...
    afterAll( async (done) => {
        ...
        var userDelete = await fetch("http://localhost:8000/api/v1/users/"+userId, {
            method: 'DELETE',
            headers: {
                    'Content-Type': 'application/json',
                    'user-id': userId,
    ...
    it('Works with get products by userId', async () => {
      console.log(userId);
        var response = await fetch(url + "/myProducts"+"/"+userId,{
            method: 'GET',
            headers: {
                    'Content-Type': 'application/json',
                    'user-id': '5fb291268c27d33204eaf0d3',
    ...
    //Testing of the apis 'get products by userId'
    //It tests if, given a bad format userId, the server responds with the status 500.

    it('Works with get products by bad format userId', async () => {
        var response = await fetch(url + "/myProducts"+"/5fb91302291e8870", {
            method: 'GET',
            headers: {
                    'Content-Type': 'application/json',
                    'user-id': '5fb291268c27d33204eaf0d3',
    ...
    it('Works with get products by not existing userId', async () => {
        var response = await fetch(url + "/myProducts/"+"5fcfb5f93346ed323aaaaaaa", {
            method: 'GET',
            headers: {
                    'Content-Type': 'application/json',
                    'user-id': '5fb291268c27d33204eaf0d3',
    ...
    it('Works with get orders by userId', async () => {
        var response = await fetch(url + "/myOrders"+"/"+userId, {
            method: 'GET',
            headers: {
                    'Content-Type': 'application/json',
                    'user-id': '5fb291268c27d33204eaf0d3',
    ...
    it('Works with get orders by bad format userId', async () => {
        var response = await fetch(url + "/myOrders"+"/5fb91302291", {
            method: 'GET',
            headers: {
                    'Content-Type': 'application/json',
                    'user-id': '5fb291268c27d33204eaf0d3',
    ...
    it('Works with get orders by not existing userId', async () => {
        console.log(productId);
        var response = await fetch(url + "/myOrders/"+"5fcfb5f93346ed323aaaaaaa", {
            method: 'GET',
            headers: {
                    'Content-Type': 'application/json',
                    'user-id': '5fb291268c27d33204eaf0d3',
