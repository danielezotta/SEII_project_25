...
describe('Tests of all apis concerning products', () => {
    ...
    it('Error 500 with put/delete product with bad format id', async () => {
    ...
    it('Error 500 with get products by bad format userId', async () => {
    ...
    it('Error 500 with get orders by bad format userId', async () => {
